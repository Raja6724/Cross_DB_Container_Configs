...
module.exports = {
  ...
  isExchangeTokenRequired: function (req) {
    ...
    let isExchangeTokenRequired = !user.businessServices || !user.businessServices[uniqueServiceName] || user.businessServices[uniqueServiceName].expireDate < Date.now();
  ...
  exchangeToken: async function (req, cb) {
    ...
    if (req.destinationCredentials.ias && req.zoneInfo) {
      ...
      if (req.destinationCredentials.ias.sharedIASToken){
        ...
        credentials.apptid = req.zoneInfo.zoneId;
