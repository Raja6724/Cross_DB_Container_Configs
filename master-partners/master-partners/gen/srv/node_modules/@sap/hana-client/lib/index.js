...
function dynamicallyAddDynatraceWrappers(conn, host, port, tenant) {
    try {
        if(hanaDynatrace && hanaDynatrace.isDynatraceEnabled()) {
        ...
        debug('Error in dynamicallyAddDynatraceWrappers: ' + ex.message);
    }
}
...
db.__setAddFnsThatAddMethodsToObjects(dynamicallyAddConnExecMethod,
                                      ...
                                      dynamicallyAddDynatraceWrappers);
if (db !== null) {
    // Does the driver support automatically adding Dynatrace wrappers?
